...
from transformers import XLNetConfig, XLNetModel, XLNetTokenizer, XLNetLMHeadModel, XLNetForSequenceClassification, XLNetTokenizerFast
...
train_utils.trainer(
    ...
    batch_size_eval=2,
    num_epochs=10,
    model_save_dir=f"models/xlnet-hiv-{out_name}",
    log_save_file=f"results/xlnet-hiv-{out_name}.log",
